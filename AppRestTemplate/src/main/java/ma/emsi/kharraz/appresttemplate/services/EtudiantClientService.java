package ma.emsi.kharraz.appresttemplate.services;
...
public class EtudiantClientService {
    ...
    private final String BASE_URL = "http://localhost:8086/etudiants";
    private static final String BASE_URL2 = "http://localhost:8086/etudiants/search/findEtudiantByNom?n={nom}";
